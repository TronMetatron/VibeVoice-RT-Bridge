...
class StreamingTTSService:
    def __init__(
        ...
        # Keep model_path as string to preserve HuggingFace repo ID format (org/model)
        # Using Path() would convert forward slashes to backslashes on Windows
    ...
    def load(self) -> None:
        ...
        if self.device == "mps":
            ...
            device_map = self.device  # Use specific device like "cuda:1"
